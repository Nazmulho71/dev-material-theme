...
Always try your best to make a positive impact on this project and its community. By participating, you are expected to uphold the [Code of Conduct](CODE_OF_CONDUCT.md). Please report any unacceptable behavior to raashida@99x.lk
...
If you've fixed a bug, started working on an enhancement, or done something else, you can [create a pull request](https://github.com/99xt-incubator/sea-green-theme/pulls) to start a conversation about your changes.
...
5. [**Open a pull request**](https://github.com/99xt-incubator/sea-green-theme/pulls) to merge your branch into `master`.
